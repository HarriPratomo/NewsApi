 ...
 */
public class Fragment_Source_General extends Fragment {
    ...
    private List<All_Source_Item> list_general = new ArrayList<>();


    public Fragment_Source_General() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment__source__general, container, false);
    }
    ...
    private void init(View view) {
        progressBar = view.findViewById(R.id.progress_source_general);
        rv_general = view.findViewById(R.id.rv_source_general);
        apiInterface = RetrofitApi.getClient().create(ApiInterface.class);
        llm = new LinearLayoutManager(getContext());
        rv_general.setLayoutManager(llm);
        loadData();
    }
        ...
        apiInterface.getListAllSource(category, Constants.API_KEY).enqueue(new Callback<All_Source_Respons>() {
            ...
            public void onResponse(Call<All_Source_Respons> call, Response<All_Source_Respons> response) {
                if (response.isSuccessful()){
                    ...
                    list_general = response.body().getSources();
                    adapter = new Adapter_All_Source(list_general,getContext());

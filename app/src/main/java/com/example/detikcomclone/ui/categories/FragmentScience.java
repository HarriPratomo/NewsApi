...
public class FragmentScience extends Fragment {
    ...
    private List<NewsArticalItem> list_science = new ArrayList<>();
        ...
        apiInterface.getListAllNewsCategory("id", category, Constants.API_KEY).enqueue(new Callback<NewsResponse>() {
            ...
            public void onResponse(Call<NewsResponse> call, Response<NewsResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    list_science = response.body().getArticles();
                    adapter = new Adapter_Toplines(list_science, getContext());

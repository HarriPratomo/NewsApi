 ...
 */
public class Fragment_Source_Science extends Fragment {


    private RecyclerView rv_science;
    private ApiInterface apiInterface;
    private ProgressBar progressBar;
    private Adapter_All_Source adapter;
    private LinearLayoutManager llm;
    private String category = "science";
    private List<All_Source_Item> list_science = new ArrayList<>();


    public Fragment_Source_Science() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment__source__science, container, false);
    }
    ...
    private void init(View view) {
        progressBar = view.findViewById(R.id.progress_source_sciencce);
        rv_science = view.findViewById(R.id.rv_source_science);
        apiInterface = RetrofitApi.getClient().create(ApiInterface.class);
        llm = new LinearLayoutManager(getContext());
        rv_science.setLayoutManager(llm);
        loadData();
    }
        ...
        apiInterface.getListAllSource(category, Constants.API_KEY).enqueue(new Callback<All_Source_Respons>() {
            ...
            public void onResponse(Call<All_Source_Respons> call, Response<All_Source_Respons> response) {
                if (response.isSuccessful()){
                    ...
                    list_science = response.body().getSources();
                    adapter = new Adapter_All_Source(list_science,getContext());
                    rv_science.setAdapter(adapter);

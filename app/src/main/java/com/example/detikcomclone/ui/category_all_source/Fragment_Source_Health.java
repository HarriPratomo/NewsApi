 ...
 */
public class Fragment_Source_Health extends Fragment {
    ...
    private List<All_Source_Item> list_health = new ArrayList<>();


    public Fragment_Source_Health() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment__source__health, container, false);
    }
    ...
    private void init(View view) {
        progressBar = view.findViewById(R.id.progress_source_health);
        rv_health = view.findViewById(R.id.rv_source_health);
        apiInterface = RetrofitApi.getClient().create(ApiInterface.class);
        llm = new LinearLayoutManager(getContext());
        rv_health.setLayoutManager(llm);
        loadData();
    }
        ...
        apiInterface.getListAllSource(category, Constants.API_KEY).enqueue(new Callback<All_Source_Respons>() {
            ...
            public void onResponse(Call<All_Source_Respons> call, Response<All_Source_Respons> response) {
                if (response.isSuccessful()){
                    ...
                    list_health = response.body().getSources();
                    adapter = new Adapter_All_Source(list_health,getContext());

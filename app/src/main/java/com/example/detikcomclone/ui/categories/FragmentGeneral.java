...
public class FragmentGeneral extends Fragment {
    ...
    private List<NewsArticalItem> list_general = new ArrayList<>();
    ...
    private void init(View view) {
        progressBar = view.findViewById(R.id.progress_general);
        recyclerView = view.findViewById(R.id.rv_general);
        apiInterface = RetrofitApi.getClient().create(ApiInterface.class);
        adapter = new Adapter_Toplines(list_general, getContext());
        ...
        apiInterface.getListAllNewsCategory("id", category, Constants.API_KEY).enqueue(new Callback<NewsResponse>() {
            ...
            public void onResponse(Call<NewsResponse> call, Response<NewsResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    list_general = response.body().getArticles();
                    adapter = new Adapter_Toplines(list_general, getContext());

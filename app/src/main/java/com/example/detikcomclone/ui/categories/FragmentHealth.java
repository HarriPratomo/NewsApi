...
public class FragmentHealth extends Fragment {
    ...
    private List<NewsArticalItem> list_health = new ArrayList<>();
        ...
        apiInterface.getListAllNewsCategory("id", category, Constants.API_KEY).enqueue(new Callback<NewsResponse>() {
            ...
            public void onResponse(Call<NewsResponse> call, Response<NewsResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    list_health = response.body().getArticles();
                    adapter = new Adapter_Toplines(list_health, getContext());
